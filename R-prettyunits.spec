...
%prep
%setup -q -n prettyunits
pushd ..
cp -a prettyunits buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695658170
...
/usr/lib64/R/library/prettyunits/R/sysdata.rdb
/usr/lib64/R/library/prettyunits/R/sysdata.rdx
...
/usr/lib64/R/library/prettyunits/tests/testthat/test-color.r
/usr/lib64/R/library/prettyunits/tests/testthat/test-ms.r
/usr/lib64/R/library/prettyunits/tests/testthat/test-numbers.r
/usr/lib64/R/library/prettyunits/tests/testthat/test-p-value.r
/usr/lib64/R/library/prettyunits/tests/testthat/test-rounding.r
